...
public class Setting implements Serializable {
	...
	/** 招行卡文件目录 */
	private String cmbcFilePath;
	/** 招行卡url目录 */
	private String cmbcUrlPath;
	/** 招行卡优惠信息 */
	private String cmbcCouponInfo;
	/** 预约单详情地址 */
	private String bespeakDetailUrl;
	 ...
	 * @return the 招行卡文件目录
	 */
	public String getCmbcFilePath() {
		return cmbcFilePath;
	}

	/**
	 * @param 招行卡文件目录
	 *            the cmbcFilePath to set
	 */
	public void setCmbcFilePath(String cmbcFilePath) {
		this.cmbcFilePath = cmbcFilePath;
	}

	/**
	 * @return the 招行卡url目录
	 */
	public String getCmbcUrlPath() {
		return cmbcUrlPath;
	}

	/**
	 * @param 招行卡url目录
	 *            the cmbcUrlPath to set
	 */
	public void setCmbcUrlPath(String cmbcUrlPath) {
		this.cmbcUrlPath = cmbcUrlPath;
	}

	/**
	 * @return the 招行卡优惠信息
	 */
	public String getCmbcCouponInfo() {
		return cmbcCouponInfo;
	}

	/**
	 * @param 招行卡优惠信息
	 *            the cmbcCouponInfo to set
	 */
	public void setCmbcCouponInfo(String cmbcCouponInfo) {
		this.cmbcCouponInfo = cmbcCouponInfo;
	}

	/**
	 * @return the 预约单详情地址
	 */
	public String getBespeakDetailUrl() {
		return bespeakDetailUrl;
	}

	/**
	 * @param 预约单详情地址
	 *            the bespeakDetailUrl to set
	 */
	public void setBespeakDetailUrl(String bespeakDetailUrl) {
		this.bespeakDetailUrl = bespeakDetailUrl;
	}
