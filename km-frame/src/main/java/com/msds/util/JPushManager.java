...
public class JPushManager {
	...
	public PushResult commonPush( PushPayload payload) {
        ...
        try {
            ...
            LOG.error("Connection error. Should retry later. ", e.getMessage());
	...
	public static String getAppKey() {
		return bundle.getString("jpush.factory.appKey");
	}

	public static String getMasterSecret() {
		return bundle.getString("jpush.factory.masterSecret");
	}
