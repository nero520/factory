 ...
 *
 */
public class JPushManagerUser {

    protected static final Logger LOG = LoggerFactory.getLogger(JPushManagerUser.class);
	private static final ResourceBundle bundle = ResourceBundle.getBundle("baseconfig");
	
	private static final JPushManagerUser jPushManager = new JPushManagerUser();	
    private static JPushClient jpushClient;

    private JPushManagerUser(){
    	init();
    }
    
	public static JPushManagerUser getInstance() {
		return SingletonHolder.instance;
	}
	
	private static class SingletonHolder{
		private static JPushManagerUser instance = new JPushManagerUser();	
	}
     ...
     * @return
     */
	public Boolean pushAll(String alert) {
	 ...
	 * @return
	 */
	public Boolean pushToRegistrationId(String alert, String... ids){
	 ...
	 * @return
	 */
	public Boolean pushToAlias(String alert, String... aliases){


		if(this.pushIosMessage(alert, aliases) || this.pushAndroidMessage(alert, aliases)){
			return true;
		}else{
			return false;
		}
	 ...
	 * @return
	 */
	public Boolean pushAndroidMessage(String alert, String... aliases){
	...
	public  Boolean pushIosMessage(String alert, String... aliases) {
		PushPayload payload =  PushPayload.newBuilder()
	 ...
	 * @return
	 */
	public Boolean pushToTag(String alert, String... tags){
	...
	public Boolean commonPush( PushPayload payload) {
	...
	public static String getAppKey() {
		return bundle.getString("jpush.user.appKey");
//		return "976b51ce8f9d85cb12fb54a5";
	}

	public static String getMasterSecret() {
		return bundle.getString("jpush.user.masterSecret");
//		return "1758c1750fccf4405e50e782";
	}
...
////		JPushUtils.pushToTag("test tag", tags);
		String[] alias ={"c1"};
//		JPushManagerUser.getInstance().pushToAlias("test alias33", alias);
		
		JPushManagerUser.getInstance().pushAndroidMessage("123123123123123","u15711291677");
		
//		JPushManagerUser.getInstance().pushAll("867543？");
	}
