...
public class DateUtils {
	...
	public enum DateStyle {
		...
		YYMM("yyMM", false), YYMMDD("yyMMdd", false), YYMMDDHHMM("yyMMddHHmm",
				false), YYMMDDHHMMSS("yyMMddHHmmss", false),

		YYYYMM("yyyyMM", false), YYYYMMDD("yyyyMMdd", false), YYYYMMDDHHMM(
				"yyyyMMddHHmm", false), YYYYMMDDHHMMSS("yyyyMMddHHmmss", false),
