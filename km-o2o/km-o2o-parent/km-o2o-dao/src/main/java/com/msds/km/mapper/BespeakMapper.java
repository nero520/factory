...
public interface BespeakMapper extends BaseMapper<BespeakEntity> {
	...
	public BespeakEntity findDetailedBySnAndCompanyId(
			@Param("bespeakSn") String bespeakSn,
	 ...
	 * @return
	 */
	public BespeakOrderDetailVo findBespeakOrderInfo(
			@Param("bespeakSn") String bespeakSn, @Param("id") Integer id);
