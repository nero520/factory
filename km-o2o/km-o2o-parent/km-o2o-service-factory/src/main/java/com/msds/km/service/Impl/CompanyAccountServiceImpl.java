...
public class CompanyAccountServiceImpl extends BaseServiceImpl<CompanyAccountEntity> implements CompanyAccountService{
	private final static Logger log= Logger.getLogger(CompanyAccountService.class);
