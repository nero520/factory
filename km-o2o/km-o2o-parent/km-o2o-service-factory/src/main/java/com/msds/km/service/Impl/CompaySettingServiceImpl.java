...
public class CompaySettingServiceImpl extends BaseServiceImpl<CompaySettingEntity> implements CompaySettingService{
	private final static Logger log= Logger.getLogger(CompaySettingService.class);
