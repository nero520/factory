...
public final class CommonAttributes {
	...
	/** factory身份信息变量 */
	public static final String FACTORY_PRINCIPAL_INFO = "FACTORY_PRINCIPAL_INFO";
	/** "用户名"Cookie名称 */
	...
	/** 行驶证信息缓存 */
	public static final String DRIVINGLICENSE_CACHE = "drivingLicense_Cache";
	/** 文件大小限制 */
	public static final long MAX_FILE_SIZE = 3 * 1024 * 1024;
	/** 预约单队列 */
	public static final String BESPEAK_QUEUE = "BESPEAK_QUEUE";
