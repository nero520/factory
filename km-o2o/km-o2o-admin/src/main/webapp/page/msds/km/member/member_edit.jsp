...
<body >
	...
	<div id="editform" class="form" >
		<input id="id" name="id" class="mini-hidden" value="${member.id }"/>
        ...
        <div class="fieldset-body">
            <table class="form-table" border="0" cellpadding="0" cellspacing="2">
                   ...
                   <td class="form-label" style="width:600px;" >
                    <input name="carSex" class="mini-textbox "   style="width:150px;" value= "<%= EnumUtil.getEnumName(((MemberEntity)request.getAttribute("member")).getCarSex(),"CarSexEnum") %>   "  enabled="false" /> 
					 </td>
                ...
                <tr>
                    ...
                    <td class="form-label" style="width:600px;" >
                    <input name="carRole" class="mini-textbox" style="width:150px;" value= "<%= EnumUtil.getEnumName(((MemberEntity)request.getAttribute("member")).getCarRole(),"CarRoleEnum") %>   "  enabled="false" /> 
					 </td>
                </tr>
                <tr id="groupNameRow" style="display: none">
                    <td class="form-label" style="text-align:right;font-size:12px;" >参考车型：</td>
                    <td class="form-label" style="width:600px;" >
                    <input id="modelGroupName" name="modelGroupName" class="mini-textbox" style="width:150px;" value= "${member.modelGroupName }"  enabled="false" />
                     <font style="color:Red;font-size:12px;">注：请参考此项，选择车型</font>
					 </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="form-label" style="width:150px;">
                      <input id="buyDate" style="width:150px;" name="buyDate" class="mini-datepicker" format="yyyy-MM-dd"  maxDate="${now }" value= "${member.buyDate }"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td >
                      <input id="lastServiceDate" style="width:150px;" name="lastServiceDate" class="mini-datepicker" format="yyyy-MM-dd" maxDate="${now }" value= "${member.lastServiceDate }"/>
                    </td>
                </tr>
                <tr>
    	...
    	<h3 class="dotBorderTop">预约单</h3>
			<div id="datagrid_member" class="mini-datagrid"
				...
				<div property="columns">
						...
						<div field="bespeakDate" dateFormat="yyyy-MM-dd"  headerAlign="center" allowSort="true">预约时间</div>
						<div field="bespeakType" headerAlign="center" renderer="onTypeRenderer" allowSort="true">预约方式</div>
						<div field="state" headerAlign="center" renderer="onGenderRenderer" allowSort="true">状态</div>
						<div field="serviceContent" headerAlign="center" allowSort="true">服务项目</div>
