...
import com.msds.km.enums.CarRoleEnum;
import com.msds.km.enums.CarSexEnum;
import com.msds.km.enums.CouponTypeEnum;
import com.msds.km.enums.MaintenanceHistoryDetailTypeEnum;
...
public class EnumUtil {
	...
	static {
		...
		jsVariableMap.put("carRole", CarRoleEnum.class);
		jsVariableMap.put("carSex", CarSexEnum.class);
		jsVariableMap.put("couponType", CouponTypeEnum.class);
		jsVariableMap.put("activityNewType", ActivityNewTypeEnum.class);
		jsVariableMap.put("activityLimitState", ActivityLimitStateEnum.class);
		jsVariableMap.put("maintenanceHistoryDetailType", MaintenanceHistoryDetailTypeEnum.class);
